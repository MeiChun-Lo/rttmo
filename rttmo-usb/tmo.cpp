...
// overwrites pyramid!
void linbcg(pyramid_t* pyramid, pyramid_t* pC, float* const b, float* const x, const int itmax, const float tol) {
...
void transform_to_luminance(pyramid_t* pp, float* const  x, const bool bcg, const int itmax, const float tol) {
